...
data_corr <- pokemon_dataset_dummy[, c("Attack", "Defense", "Speed", "HP", "Sp.Attack", "Sp.Defense", "Primary.Type_DARK", "Primary.Type_DRAGON", 
                                       "Primary.Type_ELECTRIC", "Primary.Type_FAIRY", "Primary.Type_FIGHTING", "Primary.Type_FIRE",
                                       "Primary.Type_FLYING", "Primary.Type_GHOST", "Primary.Type_GRASS", "Primary.Type_GROUND",
                                       "Primary.Type_ICE", "Primary.Type_NORMAL", "Primary.Type_POISON", "Primary.Type_PSYCHIC",
                                       "Primary.Type_ROCK", "Primary.Type_STEEL", "Primary.Type_WATER")]
...
subset_pokemon_dataset$FIRE_TYPE <- ifelse(subset_pokemon_dataset$Primary.Type == "FIRE" | subset_pokemon_dataset$Primary.Type == "DRAGON", 1, 0)
subset_pokemon_dataset$EARTH_TYPE <- ifelse(subset_pokemon_dataset$Primary.Type == "GROUND" | subset_pokemon_dataset$Primary.Type == "GRASS" | subset_pokemon_dataset$Primary.Type == "ROCK", 1, 0)
