#---------------------- Week_5_Module_5_R-Script ----------------------#

print("Author : Harshit Gaur")
print("Week 5 Assignment - Module 5 R Pratice")
...
setwd("/Users/HarshitGaur/Documents/Northeastern University/MPS Analytics/ALY 6010/Class 5/R Practice Assignment/")
